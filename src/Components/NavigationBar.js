  ...
  return (
    <>
      <div className="navigContainer">
        <div className="navig">
          <p className="animate__heartBeat">Downlaod WAY@DOOR APP <a style={{textDecoration: 'none', color: 'orangered', fontWeight: '600'}} href="https://play.google.com/store/apps/details?id=io.ionic.way2doorapp" target="_blank" rel="noopener noreferrer">click here</a></p>
          ...
          <div className="navig-content">
            ...
            <span style={{ display: "flex", alignItems: "center" }}>
              ...
              &emsp;
              <LogoutIcon sx={{ display: prod.login ? 'block' : 'none' }} onClick={logout} />
            </span>
          </div>
        </div>
        <div className="navig-second">
          ...
          <span>
            <Badge badgeContent={prod.cart.length} color="primary">
              <AddShoppingCartIcon sx={{ color: "#556d0b" }} onClick={() => setCartDrawer(true)} />
            </Badge>
          </span>
        </div>
      ...
      <Modal open={open1} onClose={() => setOpen1(false)}>
        <Box sx={style2}>
          ...
          >Note: Fully functional Sign Up Page</Typography>
        ...
        >
          <div className="top-cart-container">
            ...
            <div className="cartCon">
              <div className="cartDiv" style={{ width: prod.cartQuan < 1 ? "100%" : "75%" }}>
                {prod.cart.length < 1 ? (
                  <>
              ...
              <div className="billDiv" style={{ display: prod.cart.length < 1 ? "none" : 'block' }}>
                <h2>PRICE DETAILS ({prod.cart.length} {prod.cart.length < 2 ? "item" : "items"}):</h2>
                ...
                <div style={{ borderBottom: "1px solid" }}>
                  ...
                  <p>
                    <b>Shipping charge:</b> Rs. {prod.cart.length === 0 ? "00.00" : "15.00"}
                  </p>
                </div>
                <h3>
                  ...
                  {prod.cart
                    .reduce((total, item) => {
                      return (+(item.discountedPrice * item.cart) + total) + 5 + 10;
                    }, 0)
                    .toFixed(2)}
                </h3>

                <button className="checkoutBtn">Continue to pay <ArrowRightAltIcon /></button>
              </div>
            </div>
          </div>
